...
public class CalculatorFunctions {
  ...
  /**
   * Constructor for CalculatorFunctions. Factored out common codes of the
   * calculators.
   * 
   * @param pen
   */
  ...
  // +----------------+
  /**
   * This is a storing method that is factored out from
   * InteractiveCalculator.java, and
  ...
  public void store(String inpObj) throws Exception {
    ...
    /*
     * When RESET, reinitialize the BFCalculator class which will wipe out the
     * stored arrays
     */
